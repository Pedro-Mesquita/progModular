...
def test_cria_emprestimo(setup_emprestimos):
    ...
    cria_emprestimo(pk_id_emprestimo, data_emprestimo, data_devolucao_real, data_devolucao_prevista, fk_id_livro, fk_id_usuario)
...
def test_exclui_emprestimo(setup_emprestimos):
    ...
    cria_emprestimo(pk_id_emprestimo, data_emprestimo, data_devolucao_real, data_devolucao_prevista, fk_id_livro, fk_id_usuario)
    assert pk_id_emprestimo in emprestimos
    exclui_emprestimo(pk_id_emprestimo)
...
def test_exclui_emprestimo_nonexistent_id(setup_emprestimos): 
    ...
    with pytest.raises(ValueError, match="Empréstimo não encontrado"):
        exclui_emprestimo(pk_id_emprestimo)
...
def test_acaba_emprestimo(setup_emprestimos):
    ...
    acaba_emprestimo(pk_id_emprestimo)
...
def test_lista_emprestimos(setup_emprestimos):
    cria_emprestimo(1, "2024-11-25", None, "2024-12-25", 101, 202)
    cria_emprestimo(2, "2024-11-26", "2024-12-01", "2024-12-30", 102, 203)
